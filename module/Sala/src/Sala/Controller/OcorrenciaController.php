    ...
    public function addAction()
    {
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) { 
                ...
                $reservasala = $this->getEntityManager()->getRepository('Sala\Entity\ReservaSala')->findOneBy(array('idreservasala' => $ocorrencia->getReservaSalareservasala()));
                $ocorrencia->setReservaSalareservasala($reservasala);

                $funcionario = $this->getEntityManager()->getRepository('Funcionario\Entity\Funcionario')->findOneBy(array('idfuncionario' => $ocorrencia->getFuncionariofuncionario()));
                $ocorrencia->setFuncionariofuncionario($funcionario);
