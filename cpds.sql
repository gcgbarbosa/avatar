...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Jun-2014 às 22:16
...
CREATE TABLE IF NOT EXISTS `controle` (
  ...
  `alunoControle` int(11) NOT NULL,
  `cursoControle` int(11) NOT NULL,
  `salaControle` int(11) NOT NULL,
  `responsavelControle` int(11) NOT NULL,
  `dataEntradaControle` datetime NOT NULL,
  `dataSaidaControle` datetime DEFAULT NULL,
  `objetivoControle` varchar(50) NOT NULL,
  `statusControle` tinyint(4) NOT NULL,
...
INSERT INTO `controle` (`idControle`, `alunoControle`, `cursoControle`, `salaControle`, `responsavelControle`, `dataEntradaControle`, `dataSaidaControle`, `objetivoControle`, `statusControle`) VALUES
(2, 2, 1, 1, 1, '2014-06-11 22:02:02', '2014-06-25 20:03:17', 'Aula', 0),
(3, 2, 1, 1, 1, '2014-06-25 20:06:17', '2014-06-25 20:07:12', 'Projeto', 0),
(4, 29, 1, 1, 7, '2014-06-25 20:19:44', '2014-06-25 20:36:52', 'Estágio', 0),
(5, 29, 1, 1, 7, '2014-06-26 19:15:14', '2014-06-26 19:15:14', 'Estágio', 1);
...
(9, 2, 1, 'sadao1', 'sadao1', '13ef8e1cc699bb971b8a09629131ec46', 'sadaoyokoyama@live.com', 0, NULL, NULL, NULL, 'J:"ux[%`3vvP4f>eI3N3ps-7vsNdYk9{Ec_n66J]YJj:MxH%>m', '2014-06-26 21:56:43', 'e96ca5e5d82546e830aad35bfd303c61', 0);
...
CREATE TABLE IF NOT EXISTS `visitante` (
  ...
  `profissaoVisitante` varchar(50) NOT NULL,
  `instituicaoVisitante` varchar(50) NOT NULL,
  `objetivoVisitante` varchar(50) NOT NULL,
